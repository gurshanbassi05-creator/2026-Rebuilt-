...
public record ChoreoTraj(
    ...
    public static final ChoreoTraj Path_1 = new ChoreoTraj(
	    "Path_1",
	    OptionalInt.empty(),
	    0.74151,
	    new Pose2d(3.65, 4.077, Rotation2d.fromRadians(3.142)),
	    new Pose2d(1.662, 4.116, Rotation2d.fromRadians(3.106))
	);
